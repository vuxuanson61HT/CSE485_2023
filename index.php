    ...
    <header>
        ...
        <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-inner">
                ...
                <img src="images/slideshow/slide01.jpg" style="width: 100%; height: 250px;" class="" alt="...">
                </div>
                <div class="carousel-item">
                <img src="images/slideshow/slide02.jpg"style="width: 100%; height: 250px;" class="" alt="...">
                </div>
                <div class="carousel-item">
                <img src="images/slideshow/slide03.jpg"style="width: 100%; height: 250px;" class="" alt="...">
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center my-title">
                            <a href="detail.php" class="text-decoration-none">Người Thầy</a>
                        </h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center my-title">
                            <a href="detail.php" class="text-decoration-none">Love Me</a>
                        </h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center my-title">
                            <a href="detail.php" class="text-decoration-none">Vết Mưa</a>
                        </h5>
                    </div>
                </div>
            </div>
